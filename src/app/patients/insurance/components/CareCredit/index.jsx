...
import { CareCreditButtonWrapper, CareCreditSignUpWrapper } from "../../styles";
...
const CareCredit = () => (
  <CareCreditWrapper>
    <Typography className="nunito" style={{ fontSize: "1.4rem" }}>
    ...
    <CareCreditSignUpWrapper>
      <Image alt="care credit" height={300} src="/carecredit.png" width={300} />
